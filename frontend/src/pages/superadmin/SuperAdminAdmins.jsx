                ...
                <div key={admin.id} className="bg-white rounded-2xl shadow p-5">
                  <div className="flex justify-between items-start gap-4">
                    <div className="flex-1">
                      ...
                      {admin.contact && <p className="text-xs text-gray-400 mt-0.5">📞 {admin.contact}</p>}
                      <div className="flex flex-wrap gap-2 mt-3">
                        {primaryBranch && (
                          <span className="px-2 py-1 bg-gray-900 text-white rounded-full text-xs font-semibold">
                            ⭐ {primaryBranch.name}
                          </span>
                        )}
